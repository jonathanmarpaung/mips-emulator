...
export function Sidebar({ activeTab, setActiveTab, regValues }: SidebarProps) {
  return (
    <div className="flex flex-col w-full h-full bg-[#09090b] text-zinc-300 overflow-hidden">
      ...
      {/* HEADER: flex-none menjamin tinggi 52px tidak akan pernah menyusut atau membesar */}
      <div className="flex-none h-[52px] flex items-center gap-4 px-4 pr-12 border-b border-zinc-900 bg-[#09090b] shadow-sm z-10">
      ...
      {/* KONTEN SCROLL: flex-1 dan min-h-0 memaksa browser memunculkan scroll bar */}
